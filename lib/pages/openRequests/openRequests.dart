    ...
    return WillPopScope(
      ...
      child: Scaffold(
          appBar: CustomMainAppbar(
            title: LocaleKeys.myOpenRequests,
            returnBack: true,
            actions: [
              IconButton(icon: Icon(Icons.arrow_back, color: APPColors.Main.black), onPressed: () {}),
            ],
          ),
          body: Stack(
            children: [
                                    ...
                                    Padding(
                                      ...
                                      child: TaskListWidget(
                                          ...
                                          onPressed: (code) {
                                            ...
                                            Navigator.pushNamed(context, OpenRequestDetail.pageName);
                                            print('tiklandi' + code);
                                          },
                                          onPressedLong: () {
                                            print('pressed');
      ...
      return InkWell(
        onTap: () {
          setState(() {
            ...
            listViewProvider.loadData(listViewProvider.currentPage, 'OpenIssuesIsCustomer');
          });
        },
        child: const Padding(

...
class ClosedRequestDetail extends StatefulWidget {
  static String closedRequestDetail = 'ClosedRequestDetail';

  const ClosedRequestDetail({Key? key}) : super(key: key);
  @override
  State<ClosedRequestDetail> createState() => _ClosedRequestDetailState();
}
...
class _ClosedRequestDetailState extends State<ClosedRequestDetail> {
  @override
  void initState() {
    super.initState();

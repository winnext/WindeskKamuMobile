                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    Text(summary['STATUS'] == null ? 'Veri Yok' : summary['STATUS'],
                                                        style: TextStyle(
                                                          color: Colors.white,
                                                        ))
                                                  ],
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    Container(
                                                        width: 50.w,
                                                        child: Text(summary['CATEGORY'] == null ? 'Veri Yok' : summary['CATEGORY'],
                                                            style: TextStyle(
                                                              color: Colors.white,
                                                            )))
                                                  ],
                                                ...
                                                content: SingleChildScrollView(
                                                  child: Column(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      sla.length > 0 ? Text('') : Text(' Sonuç Bulunamadı ')
                                                    ],
                                                  ),
                                                )),
                                            AccordionSection(
                                                ...
                                                content: SingleChildScrollView(
                                                  child: Column(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      bakim_is_emri.length > 0 ? Text('') : Text(' Sonuç Bulunamadı ')
                                                    ],
                                                  ),
                                                )),
                                            AccordionSection(
                                                ...
                                                content: SingleChildScrollView(
                                                  child: Column(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      anlik_is_emri.length > 0 ? Text('') : Text(' Sonuç Bulunamadı ')
                                                    ],
                                                  ),
                                                )),
                                          ],

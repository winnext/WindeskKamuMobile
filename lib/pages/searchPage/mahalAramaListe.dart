...
class MahalAramaListe extends StatefulWidget {
  const MahalAramaListe({super.key});

  @override
  State<MahalAramaListe> createState() => _MahalAramaListeState();
}

class _MahalAramaListeState extends State<MahalAramaListe> {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
            ...
            title: Text('Mahal Arama Liste',style: TextStyle(color: Colors.black),),
            centerTitle: true,
            leading: IconButton(
                onPressed: () {
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(codes[i],style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25),),
                                            Text(names[i],style: TextStyle(fontSize: 19),),
                                            Text(''),
                                            Text(locTrees[i],style: TextStyle(fontSize: 15),),

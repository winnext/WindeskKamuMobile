...
class StatefullActionModal extends StatefulWidget {
  String? code;
  StatefullActionModal({super.key, this.code});
  @override
  // ignore: library_private_types_in_public_api
  _StatefullActionModalState createState() => _StatefullActionModalState();
}

class _StatefullActionModalState extends State<StatefullActionModal> {

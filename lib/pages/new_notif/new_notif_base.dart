...
class _NewNotifBaseState extends State<NewNotifBase> {
  ...
  Widget build(BuildContext context) {
    ...
    return Sizer(builder: (context, orientation, deviceType) {
      return Scaffold(
          ...
          appBar: _newNotifAppbar(context),
          body: Column(
            children: [
              Expanded(
                child: ListView(
                        ...
                        child: Column(
                          children: [
                              ...
                              children: [
                                Container(
                                  ...
                                  child: TextField(
                                    ...
                                    decoration:
                                        InputDecoration(border: UnderlineInputBorder(), hintText: 'Mahal', hintStyle: TextStyle(color: Colors.black)),
                                  ),
                                ),
                                Container(
                                  width: 10.w,
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(hintText: 'Arayan Numara', hintStyle: TextStyle(color: Colors.black)),
                            ),
                            Center(
                              child: Container(
                                  height: 10.h,
  ...
  AppBar _newNotifAppbar(BuildContext context) {
    return AppBar(

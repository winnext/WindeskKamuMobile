                                        ...
                                        child: Column(
                                          children: [
                                            DetailListWidget(
                                              ...
                                              targetFDate: isEmpty(detailElements.TARGET_FDATE.toString()),
                                              targetRDate: isEmpty(detailElements.TARGET_RDATE.toString()),
                                              ...
                                              hys: isEmptyorUndefined(detailElements.HDS.toString()),
                                              hds: isEmptyorUndefined(detailElements.HDS.toString()),
                                              onPressed: (code) {},
                                              fixTimer: isEmpty(issueSummary!.FIX_TIMER.toString()),
                                              fixedDate: isEmpty(issueSummary!.FIXED_DATE.toString()),
                                              respondedDate: isEmpty(issueSummary!.RESPONDED_DATE.toString()),
                                              respondedTimer: isEmpty(issueSummary!.RESPONDED_TIMER.toString()),
